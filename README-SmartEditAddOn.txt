...
twikismartWikiHomeURL = '%SCRIPTURL%/view'; 
...
twikismartTWikiSiteIcons = ''+'%SMARTEDITICONSITE%';
twikismartTWikiWebIcons = ''+'%SMARTEDITICONWEB%';
twikismartTWikiUserIcons = ''+'%SMARTEDITICONUSER%';
// End of copy
